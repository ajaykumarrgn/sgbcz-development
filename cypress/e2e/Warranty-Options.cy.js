describe('Testcase for the SGB Warranty Options', () => {
  ...
  describe('Verify that the new warranty options were added', () => {
      ...
      it('Should save the Customer with new Warranty Options', () => {
          ...
          cy.get('[data-original-title="Customer Name"] > .input-with-feedback').clear({force:true})
          cy.get('[data-original-title="Customer Name"] > .input-with-feedback').type(LA_TESTDATA[7].value).wait(1000)
      ...
      it('Should Check the Warranrty in sales order with the customer', () => {
          ...
          .click()
          .wait(4000)
          .type(LA_TESTDATA[7].value ,'enter')
          .wait(4000)
          .type('{enter}');   //customer
        cy.wait(4000);
          // .click({ force: true })
          // .type(LA_TESTDATA[7].value, { force: true })
          // .wait(500)
          // .type(LA_TESTDATA[7].value + '{enter}', { force: true, timeout: 3000 });
